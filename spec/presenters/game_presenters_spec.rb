...
HEREDOC
    ...
    context 'observation granularity' do
      let(:response) do
<<HEREDOC
{"_id":"#{game.id}","name":"#{game.name}","simulator_fullname":"#{game.simulator_fullname}","configuration":#{game.configuration.to_json},"roles":{"name":"Role1","strategies":["Strat1"],"count":2},{"name":"Role2","strategies":["Strat2", "Strat3"],"count":2},"profiles":[{"_id":"#{profile.id}","observations":[{"features":{"feature1":23,"feature2":25},"symmetry_groups":[{"role":"Role1","strategy":"Strat1","count":2,"payoff":11,"payoff_sd":1},{"role":"Role2","strategy":"Strat2","count":1,"payoff":10,"payoff_sd":0},{"role":"Role2","strategy":"Strat3","count":1,"payoff":10,"payoff_sd":0}]}]}]}
HEREDOC
      end
    ...
    context 'full granularity' do
      let(:response) do
<<HEREDOC
{"_id":"#{game.id}","name":"#{game.name}","simulator_fullname":"#{game.simulator_fullname}","configuration":#{game.configuration.to_json},"roles":{"name":"Role1","strategies":["Strat1"],"count":2},{"name":"Role2","strategies":["Strat2", "Strat3"],"count":2},"profiles":[{"_id":"#{profile.id}","observations":[{"features":{"feature1":23,"feature2":25},"symmetry_groups":[{"role":"Role1","strategy":"Strat1","count":2,"players":[{"features":{"pfeature1":-11,"pfeature2":0.23},"payoff":10},{"features":{"pfeature1":-9,"pfeature2":0.43},"payoff":12}]},{"role":"Role2","strategy":"Strat2","count":1,"players":[{"features":{"pfeature3":-11,"pfeature4":0.27},"payoff":10}]},{"role":"Role2","strategy":"Strat3","count":1,"players":[{"features":{"pfeature3":-14,"pfeature4":0.47},"payoff":10}]}]}]}]}
HEREDOC
      end
