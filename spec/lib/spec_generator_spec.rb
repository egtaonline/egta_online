...
describe SpecGenerator do
  describe 'generate' do
    ...
    it 'creates a simulation_spec.json file' do
      Oj.should_receive(:to_file).with('tmp/out', { assignment: { 'Bidder' => ['Shade1', 'Shade1', 'Shade2'], 'Seller' => ['FirstPrice', 'FirstPrice', 'FirstPrice', 'SecondPrice'] }, configuration: profile.configuration }, indent: 2)
      SpecGenerator.generate('tmp/out', profile)
    end
  end
end